...
def test():
    if runFunction({"drugList":{"lisinopril 40 mg tablet":{"route":"oral","form":"capsules/tablets","dosing frequency":"twice daily","additional directions":""},"metroprolol tartrate 100 mg tablet":{"route":"oral","form":"capsules/tablets", "dosing frequency":"twice daily","additional directions":"break or crush tablet"},"amLODIPine 10 mg tablet":{"route":"oral","form":"capsules/tablets","dosing frequency":"once daily","additional directions":""},"levothyroxine 75 mcg capsule":{"route":"oral","form":"capsules/tablets","dosing frequency":"once daily","additional directions":"alternating dose"}}}) == 13:
        print ("ok.")
    else:
        print ("error.")

    if runFunction({"drugList":{"colchicine 0.l6mg tablet":{"route":"oral","form":"capsules/tablets","dosing frequency":"twice daily","additional directions":""},"ferrous sulfate 324 mg":{"route":"oral","form":"capsules/tablets","dosing frequency":"on alternate days or less frequently","additional directions":"relation to food"}}}) == 7:
        print ("ok.")
    else:
        print ("error.")

    if runFunction({"drugList":{"Erythropoietin":{"route":"others","form":"dialysate","dosing frequency":"q 12h","additional directions":""},"atenolol 25 mg tablet":{"route":"oral","form":"capsules/tablets","dosing frequency":"on alternate days or less frequently","additional directions":"take with specific fluid"}}}) == 11.5:
        print ("ok.")
    else:
        print ("error.")
    ...
    if runFunction({"drugList":{"Erythropoietin":{"route":"inhalation","form":"chewable","dosing frequency":"","additional directions":""}}}) ==  0:
        print ("ok.")
    else:
        print ("error.")

    if runFunction({"drugList":{"Advil AM":{"route":"oral or nasal","form":"","dosing frequency":"","additional directions":""},"Advil PM":{"route":"oral","form":"","dosing frequency":"","additional directions":""}}}) == 0:
        print ("ok.")
    else:
        print ("error.")
